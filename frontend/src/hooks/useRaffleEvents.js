 ...
 */
export const useRaffleEvents = (options = {}) => {
    const { activityId, participantId, onRaffleStarted, onEntryConfirmed, onDrawing, onWinnersAnnounced, onRaffleEnded, } = options;
    ...
    const isWinner = useCallback((checkParticipantId) => {
