  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <motion.div
        ...
        className="bg-white/10 backdrop-blur-sm shadow-2xl rounded-2xl p-8 md:p-12 text-center border border-white/20"
      >
        {/* Animated icon */}
        <motion.div
          animate={{
          ...
          className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-blue-500/20 rounded-full mb-6"
        >
          <svg
        ...
        {eventName && (
          <div className="mb-4">
            <p className="text-sm md:text-base text-white/70 mb-1">Event</p>
            <p className="text-xl md:text-2xl font-bold text-white">{eventName}</p>
          </div>
        )}
        ...
        {participantCount !== undefined && participantCount > 0 && (
          ...
          >
            ...
            <span className="text-white font-semibold">
              {participantCount} {participantCount === 1 ? 'participant' : 'participants'} waiting
            </span>
          </motion.div>
        )}
